...
public class Good_Ending extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblFondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Examen/Recursos/Background_1 - copia.png"))); // NOI18N
        ...
        jTextArea1.setText("Parece que he llegado al final del camino.\n\nMe pregunto a mi mismo cuanto tiempo habrá pasado, \nes difícil saberlo cuando el cielo no muestra más que penumbra \ny los alrededores se vuelven siniestros con la bendición \nde las sombras. \n\nSin embargo, no toda esperanza ha muerto, pues mi paciencia \nha demostrado tener frutos… \n\nAgradezco el poder haber llegado allí pese al cansancio \ny el terror, porque una vez que vi a otra persona, \ncon sus ojos vivos y temerosos como los míos… \n\nFinalmente me rompería en llanto, \nalegrándome que aquel horror haya cesado brevemente \npara abrazar un ápice de esperanza. \n\nParece que el viejo guardabosques entiende mi desesperación \ny me deja entrar.\n\nUn calor acogedor me recibe, \nahora solo debo esperar a que el sol vuelva una vez más.\n");
