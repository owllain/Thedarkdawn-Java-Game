...
public class Ruta_1 extends javax.swing.JFrame {
    ...
    public Ruta_1() {
        ...
        jrdRuta1.setText(textbased.arrayRutas[1].getRutaOpcion1());
        jrdRuta2.setText(textbased.arrayRutas[1].getRutaOpcion2());
        jrdRuta3.setText(textbased.arrayRutas[1].getRutaOpcion3());
    ...
    private void initComponents() {
        ...
        lblFondo1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Examen/Recursos/Grass_background_2.png"))); // NOI18N
        jpCuerpo.add(lblFondo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 50, 200, 390));
        ...
        jLabel1.setText("Los minutos pasan como una insondable eternidad...");
        ...
        jTextArea1.setText("Siento que mi respiración se tranquiliza y aguardo, \ntemeroso de lo que pudiese suceder al encontrarme allí solo \ny desprotegido. Una sensación de abandono tan grande \nque me sobrecoge. La idea de continuar se me hace difícil de \nconcebir, la ansiedad crece en mí mientras me voy diciendo \na mi mismo cualquier excusa para tan solo quedarme allí.\n\nNormalmente en un bosque como este escucharía una lechuza o, \naunque sean grillos, pero la noche era como un cementerio. \nMe maldije a mi mismo por tal analogía, pero era la verdad \ncomo si algo maligno durmiese bajo las ramas de los árboles. \n\nY que peor que el terror de un hombre como \npara darle forma a sus miedos ante el frondoso camino.\n\nCada rama y cada roca formaban en mi cabeza imágenes \nde horrores que no me atrevía a bautizar, \ncriaturas sin nombre que me asecharían en mis horas de vigilia \nsino tenia cuidado en diferenciar que es real \ny que es una ilusión de mi mente, de mi pavor.\n\nTomo la decisión de continuar...\n mientras la esperanza muere en mi interior.\n");
        ...
        jpCuerpo.add(jrdRuta1, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 310, 410, -1));
        ...
        jpCuerpo.add(jrdRuta2, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 340, 410, -1));
        ...
        jpCuerpo.add(jrdRuta3, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 370, 410, -1));
