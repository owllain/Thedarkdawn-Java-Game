...
public class Ruta_3 extends javax.swing.JFrame {
    ...
    public Ruta_3() {
        ...
        jrdRuta1.setText(textbased.arrayRutas[3].getRutaOpcion1());
        jrdRuta2.setText(textbased.arrayRutas[3].getRutaOpcion2());
    ...
    private void initComponents() {
        ...
        lblFondo1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Examen/Recursos/Background_1.png"))); // NOI18N
        ...
        jLabel1.setText("Nada desespera tanto como el ver la esperanza extingirse.");
        ...
        jTextArea1.setText("¡Corre, corre y no mires atrás!\n\nDebo exprimir cada gota de mi ser para alejarme del caos \ny la muerte que asolan la ciudad, sabia que tarde o temprano \nla luz volvería a resplandecer, pero tenia miedo de que aquellos \nque habían vuelto desde el abismo me alcanzaran. \n\n¿Qué tan terrible puede ser que las leyendas sean verdad? \nNo quería afrontarlo, tan solo necesitaba huir, \nno me sentiría seguro al descansar bajo la sombra del bosque. \n\nPronto sentiría como mis pulmones estaban por explotar, \narrastraba mis pies aun cuando ya había perdido la voluntad \nde continuar, estaba cerca… Podía sentirlo.\n\nMis esfuerzos fueron recompensados, pude ver a la \ndistancia una cabaña con luces encendidas, \nrecordaba haber ido allí hace unos años. \n\nVivía un guardabosques bastante mayor y que constantemente \ncontaba historias sobre el fin del mundo.\n\nMe acercaría para tocar la puerta, mientras sentía como la estatua\nde la capilla me miraba fijamente. Pregunté más ansiosamente \nsi había alguien allí, esperando recibir respuesta más que \nel silencio del bosque. \n\nRetrocedí unos pasos, \nmis instintos me gritaban que saliera de allí y \njusto en ese momento, la puerta se abriría.\n");
